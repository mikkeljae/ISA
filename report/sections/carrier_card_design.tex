...
\textit{This is very badly written. Only meant as notes.}\\
To maintain proper power off sequencing \cite{design_carrier} VCCIO\_EN needs to be turned pulled low before PWR\_EN goes low.
This it done with a small RC circuit that needs to be charged before PWR\_EN goes low. 
The inhibit signal of the swarmbots DC/DC converter needs to be pulled low after the two other signals. Therefore a slower charging RC circuit is in front of the MOSFET that pulls it low.
